...
import fBurger1 from "../../assests/fBurger1.jpg";
...
class Auth extends Component {
    ...
    render() {
        ...
        return (
            <div className="authdivbyme">
                <div>
                <p class="double"> To customize your burger :: new users please Sign up and exisiting users click on switch to Login ! </p>
                
                </div>
                {err}
                {form}
                <div>
                    <img src={fBurger1} className="imgdesign" alt="Burger"/>
                </div>
